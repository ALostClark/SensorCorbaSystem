...
import clark.corba.MonitorStationHelper;
...
public class MonitorStationOrb {
    ...
    // TODO: Change
    public void bindObjectToName(String name, MonitorStation station) throws ServantNotActive, WrongPolicy, CannotProceed, InvalidName, NotFound {
        Object ref = portableObjectAdapter.servant_to_reference(station);

        namingContextExt.rebind(namingContextExt.to_name(name), MonitorStationHelper.narrow(ref));
    }

    // TODO: Change
    public clark.corba.MonitorStation getObjectAtReference(String name) throws CannotProceed, InvalidName, NotFound {
        return MonitorStationHelper.narrow(namingContextExt.resolve_str(name));
    }
